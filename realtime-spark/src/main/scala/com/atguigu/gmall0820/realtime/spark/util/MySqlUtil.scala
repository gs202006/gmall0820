...
//import com.mysql.jdbc.{Connection, ResultSetMetaData, Statement}
...
object  MySqlUtil {
  ...
  def   queryList(sql:String):java.util.List[JSONObject]={
    ...
    val conn: Connection = DriverManager.getConnection("jdbc:mysql://hadoop102:3306/gmall0820?characterEncoding=utf-8&useSSL=false","root","root")
